...
public class FoodListAdapter3 extends RecyclerView.Adapter<FoodListAdapter3.ViewHolder> {
    ...
    public FoodListAdapter3(List<RecipeModel> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public FoodListAdapter3.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.foodlistlayout3,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FoodListAdapter3.ViewHolder holder, final int position) {
